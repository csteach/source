...
INSERT INTO `content` (`contentid`, `contentname`, `contentdesc`, `contenttext`, `contentimage`, `contentmap`, `contentaudio`, `contentcreated`) VALUES
...
(33, 'Fishing at sunset', 'father and son fishing at sunset on the Breakwater, Brixham', '', 'img7.jpg', '', '', '2014-04-07 01:27:38'),
...
(6, 'brixham, devon, harbour, map', 'google maps api', 'ancientlives');
...
(13, 'Brixham', 'all material for the collection ''Brixham''', 'taxonomy&id=3'),
(12, 'Devon', 'all material for the collection ''Devon''', 'taxonomy&id=1'),
(14, 'Torquay gallery', 'an image gallery of Torquay, Devon', 'content/image/gallery&id=4'),
(15, 'Torquay', 'all material for the collection ''Torquay''', 'taxonomy&id=4'),
(11, 'atlases', 'an overview of site atlases', 'content/text&id=10'),
(18, 'Brixham maps', 'a collection of maps of Brixham, Devon', 'content/map/atlas&id=3');
