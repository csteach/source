...
pygame.display.set_caption("sprites - graphics - add images")
...
class Mob(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        # load mob object image & scale to fit game window...
        self.image = pygame.transform.scale(mob_img, (23, 21))
        # set colorkey to remove black background for mob's rect
        self.image.set_colorkey(BLACK)
...
# meteor
mob_img = pygame.image.load(os.path.join(img_dir, "mob.png")).convert()
